...
export declare function link<TSource, TArgs>(options: {
    by: string;
    type?: import("graphql").GraphQLScalarType | import("graphql").GraphQLInterfaceType | import("graphql").GraphQLUnionType | import("graphql").GraphQLEnumType | import("graphql").GraphQLInputObjectType | import("graphql").GraphQLObjectType<any, any> | GraphQLList<any> | import("graphql").GraphQLNonNull<any> | undefined;
