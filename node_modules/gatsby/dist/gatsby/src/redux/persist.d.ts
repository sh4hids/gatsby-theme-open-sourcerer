...
export declare function readFromCache(slices?: Array<GatsbyStateKeys>): DeepPartial<ICachedReduxState>;
...
export declare function writeToCache(contents: DeepPartial<ICachedReduxState>, slices?: Array<GatsbyStateKeys>): void;
