...
async function initialize({
  ...
  _redux.store.dispatch((0, _removeStaleJobs.removeStaleJobs)(_redux.store.getState())); // Multiple occurrences of the same name-version-pair can occur,
  ...
  const publicDirExists = _fsExtra.default.existsSync(publicDirectory); // For builds in case public dir exists, but cache doesn't, we need to clean up potentially stale
