...
var _default$3 = isFullwidthCodePoint;
isFullwidthCodePoint_1.default = _default$3;
...
var _default$4 = stringWidth;
stringWidth_1.default = _default$4;
...
var _default$5 = widestLine;
widestLine_1.default = _default$5;
...
const widest_line_1 = __importDefault$1(widestLine_1);
...
const yoga_layout_prebuilt_1 = __importDefault$2(require$$0__default['default']);
...
var _default$8 = isFullwidthCodePoint$1;
isFullwidthCodePoint_1$1.default = _default$8;
...
const wrap_ansi_1 = __importDefault$3(wrapAnsi_1);

const cli_truncate_1 = __importDefault$3(cliTruncate);

const cache$1 = {};

var _default$9 = (text, maxWidth, wrapType) => {
...
var _default$a = squashTextNodes;
...
const react_reconciler_1 = __importDefault$4(reactReconciler);

const yoga_layout_prebuilt_1$1 = __importDefault$4(require$$0__default['default']);
...
var _default$b = react_reconciler_1.default({
  ...
  hideInstance: node => {
    ...
    (_a = node.yogaNode) === null || _a === void 0 ? void 0 : _a.setDisplay(yoga_layout_prebuilt_1$1.default.DISPLAY_NONE);
  },
  unhideInstance: node => {
    var _a;

    (_a = node.yogaNode) === null || _a === void 0 ? void 0 : _a.setDisplay(yoga_layout_prebuilt_1$1.default.DISPLAY_FLEX);
  },
...
const yoga_layout_prebuilt_1$2 = __importDefault$5(require$$0__default['default']);

var _default$c = yogaNode => {
...
var _default$d = cliBoxes;
cliBoxes_1.default = _default$d;
...
const chalk_1 = __importDefault$6(require$$0__default$1['default']);
...
const cli_boxes_1 = __importDefault$7(cliBoxes_1);

const colorize_1 = __importDefault$7(colorize);

var _default$f = (x, y, node, output) => {
...
const yoga_layout_prebuilt_1$3 = __importDefault$8(require$$0__default['default']);

const widest_line_1$1 = __importDefault$8(widestLine_1);

const indent_string_1 = __importDefault$8(indentString);

const wrap_text_1 = __importDefault$8(wrapText);

const get_max_width_1 = __importDefault$8(getMaxWidth);

const squash_text_nodes_1 = __importDefault$8(squashTextNodes_1);

const render_border_1 = __importDefault$8(renderBorder); // If parent container is `<Box>`, text nodes will be treated as separate nodes in
...
const renderNodeToOutput = (node, output, options) => {
  ...
  if (yogaNode) {
    if (yogaNode.getDisplay() === yoga_layout_prebuilt_1$3.default.DISPLAY_NONE) {
      return;
    ...
    if (node.nodeName === 'ink-text') {
      ...
      if (text.length > 0) {
        const currentWidth = widest_line_1$1.default(text);
...
var _default$g = renderNodeToOutput;
...
const stringLength = string => stripAnsi__default['default'](string).replace(astralRegex$1(), ' ').length;

var stringLength_1 = stringLength; // TODO: Remove this for the next major release

var _default$h = stringLength;
stringLength_1.default = _default$h;
...
const slice_ansi_1 = __importDefault$9(sliceAnsi);

const string_length_1 = __importDefault$9(stringLength_1);
...
const yoga_layout_prebuilt_1$4 = __importDefault$a(require$$0__default['default']);

const render_node_to_output_1 = __importDefault$a(renderNodeToOutput_1);

const output_1 = __importDefault$a(output);

var _default$j = (node, terminalWidth) => {
  var _a;

  node.yogaNode.setWidth(terminalWidth);

  if (node.yogaNode) {
    node.yogaNode.calculateLayout(undefined, undefined, yoga_layout_prebuilt_1$4.default.DIRECTION_LTR);
...
var _default$l = AppContext;

var AppContext_1 = /*#__PURE__*/Object.defineProperty({
	default: _default$l
}, '__esModule', {value: true});
...
var _default$m = StdinContext;

var StdinContext_1 = /*#__PURE__*/Object.defineProperty({
	default: _default$m
}, '__esModule', {value: true});
...
var _default$n = StdoutContext;

var StdoutContext_1 = /*#__PURE__*/Object.defineProperty({
	default: _default$n
}, '__esModule', {value: true});
...
var StderrContext_1 = /*#__PURE__*/Object.defineProperty({
	default: _default$o
}, '__esModule', {value: true});
...
var _default$p = FocusContext;

var FocusContext_1 = /*#__PURE__*/Object.defineProperty({
	default: _default$p
}, '__esModule', {value: true});
...
var Box_1 = /*#__PURE__*/Object.defineProperty({
	default: _default$q
}, '__esModule', {value: true});
...
const react_1$1 = __importDefault$b(react);

const chalk_1$1 = __importDefault$b(require$$0__default$1['default']);

const colorize_1$1 = __importDefault$b(colorize);
/**
...
const Text = ({
  ...
  const transform = children => {
    if (dimColor) {
      children = chalk_1$1.default.dim(children);
    }

    if (color) {
      children = colorize_1$1.default(children, color, 'foreground');
    }

    if (backgroundColor) {
      children = colorize_1$1.default(children, backgroundColor, 'background');
    }

    if (bold) {
      children = chalk_1$1.default.bold(children);
    }

    if (italic) {
      children = chalk_1$1.default.italic(children);
    }

    if (underline) {
      children = chalk_1$1.default.underline(children);
    }

    if (strikethrough) {
      children = chalk_1$1.default.strikethrough(children);
    }

    if (inverse) {
      children = chalk_1$1.default.inverse(children);
    }

    return children;
  };

  return react_1$1.default.createElement("ink-text", {
    style: {
      flexGrow: 0,
      flexShrink: 1,
      flexDirection: 'row',
...
const fs = __importStar$1(require$$0__default$3['default']);

const react_1$2 = __importDefault$c(react);

const stack_utils_1 = __importDefault$c(stackUtils);

const code_excerpt_1 = __importDefault$c(codeExcerpt);

const Box_1$1 = __importDefault$c(Box_1);

const Text_1$1 = __importDefault$c(Text_1);
...
const ErrorOverview = ({
  ...
  return react_1$2.default.createElement(Box_1$1.default, {
    flexDirection: "column",
    padding: 1
  }, react_1$2.default.createElement(Box_1$1.default, null, react_1$2.default.createElement(Text_1$1.default, {
    backgroundColor: "red",
    color: "white"
  }, ' ', "ERROR", ' '), react_1$2.default.createElement(Text_1$1.default, null, " ", error.message)), origin && react_1$2.default.createElement(Box_1$1.default, {
    marginTop: 1
  }, react_1$2.default.createElement(Text_1$1.default, {
    dimColor: true
  }, origin.file, ":", origin.line, ":", origin.column)), origin && excerpt && react_1$2.default.createElement(Box_1$1.default, {
    marginTop: 1,
    flexDirection: "column"
  }, excerpt.map(({
    line,
    value
  }) => react_1$2.default.createElement(Box_1$1.default, {
    key: line
  }, react_1$2.default.createElement(Box_1$1.default, {
    width: lineWidth + 1
  }, react_1$2.default.createElement(Text_1$1.default, {
  ...
  }, String(line).padStart(lineWidth, ' '), ":")), react_1$2.default.createElement(Text_1$1.default, {
    key: line,
    backgroundColor: line === origin.line ? 'red' : undefined,
    color: line === origin.line ? 'white' : undefined
  }, ' ' + value)))), error.stack && react_1$2.default.createElement(Box_1$1.default, {
    marginTop: 1,
    flexDirection: "column"
  }, error.stack.split('\n').slice(1).map(line => {
    ...
    return react_1$2.default.createElement(Box_1$1.default, {
      ...
      dimColor: true,
      bold: true
    }, parsedLine.function), react_1$2.default.createElement(Text_1$1.default, {
      dimColor: true,
      color: "gray"
...
var _default$s = ErrorOverview;

var ErrorOverview_1 = /*#__PURE__*/Object.defineProperty({
	default: _default$s
}, '__esModule', {value: true});
...
const react_1$3 = __importStar$2(react);

const cli_cursor_1$1 = __importDefault$d(cliCursor);

const AppContext_1$1 = __importDefault$d(AppContext_1);

const StdinContext_1$1 = __importDefault$d(StdinContext_1);

const StdoutContext_1$1 = __importDefault$d(StdoutContext_1);

const StderrContext_1$1 = __importDefault$d(StderrContext_1);

const FocusContext_1$1 = __importDefault$d(FocusContext_1);

const ErrorOverview_1$1 = __importDefault$d(ErrorOverview_1);
...
class App extends react_1$3.PureComponent {
  constructor() {
    super(...arguments);
    this.state = {
      isFocusEnabled: true,
  ...
  render() {
    return react_1$3.default.createElement(AppContext_1$1.default.Provider, {
      value: {
        exit: this.handleExit
      }
    }, react_1$3.default.createElement(StdinContext_1$1.default.Provider, {
      value: {
    ...
    }, react_1$3.default.createElement(StdoutContext_1$1.default.Provider, {
      value: {
        stdout: this.props.stdout,
        write: this.props.writeToStdout
      }
    }, react_1$3.default.createElement(StderrContext_1$1.default.Provider, {
      value: {
        stderr: this.props.stderr,
        write: this.props.writeToStderr
      }
    }, react_1$3.default.createElement(FocusContext_1$1.default.Provider, {
      value: {
    ...
    }, this.state.error ? react_1$3.default.createElement(ErrorOverview_1$1.default, {
      error: this.state.error
    }) : this.props.children)))));
  }

  componentDidMount() {
    cli_cursor_1$1.default.hide(this.props.stdout);
  }

  componentWillUnmount() {
    cli_cursor_1$1.default.show(this.props.stdout); // ignore calling setRawMode on an handle stdin it cannot be called
...
var App_1 = /*#__PURE__*/Object.defineProperty({
	default: _default$t
}, '__esModule', {value: true});
...
const react_1$4 = __importDefault$e(react);



const log_update_1 = __importDefault$e(logUpdate);

const ansi_escapes_1$1 = __importDefault$e(ansiEscapes_1);

const is_ci_1 = __importDefault$e(isCi);

const auto_bind_1 = __importDefault$e(autoBind);

const reconciler_1 = __importDefault$e(reconciler);

const renderer_1 = __importDefault$e(renderer);

const signal_exit_1 = __importDefault$e(signalExit__default['default']);

const patch_console_1 = __importDefault$e(build);

const dom$1 = __importStar$3(dom);

const instances_1 = __importDefault$e(instances);

const App_1$1 = __importDefault$e(App_1);
...
class Ink {
  constructor(options) {
    ...
    this.onRender = () => {
      ...
      if (outputHeight >= this.options.stdout.rows) {
        this.options.stdout.write(ansi_escapes_1$1.default.clearTerminal + this.fullStaticOutput + output);
        this.lastOutput = output;
        return;
  ...
  render(node) {
    const tree = react_1$4.default.createElement(App_1$1.default, {
...
const ink_1 = __importDefault$f(ink);

const instances_1$1 = __importDefault$f(instances);
...
const render = (node, options) => {
  ...
  return {
    ...
    cleanup: () => instances_1$1.default.delete(inkOptions.stdout),
    clear: instance.clear
  };
};

var _default$v = render;
...
const getInstance = (stdout, createInstance) => {
  ...
  if (instances_1$1.default.has(stdout)) {
    instance = instances_1$1.default.get(stdout);
  } else {
    instance = createInstance();
    instances_1$1.default.set(stdout, instance);
  }
...
const react_1$5 = __importStar$4(react);
/**
...
const react_1$6 = __importDefault$g(react);
/**
...
const Transform = ({
  ...
  return react_1$6.default.createElement("ink-text", {
    style: {
      flexGrow: 0,
      flexShrink: 1,
      flexDirection: 'row'
...
const react_1$7 = __importDefault$h(react);
/**
...
const Newline = ({
  count = 1
}) => react_1$7.default.createElement("ink-text", null, '\n'.repeat(count));

Newline.displayName = 'Newline';
var _default$y = Newline;
...
const react_1$8 = __importDefault$i(react);

const Box_1$2 = __importDefault$i(Box_1);
/**
...
const Spacer = () => react_1$8.default.createElement(Box_1$2.default, {
  flexGrow: 1
});

Spacer.displayName = 'Spacer';
var _default$z = Spacer;
...
const StdinContext_1$2 = __importDefault$j(StdinContext_1);
/**
 * `useStdin` is a React hook, which exposes stdin stream.
 */


const useStdin = () => react.useContext(StdinContext_1$2.default);

var _default$A = useStdin;
...
const use_stdin_1 = __importDefault$k(useStdin_1);
/**
...
const AppContext_1$2 = __importDefault$l(AppContext_1);
/**
 * `useApp` is a React hook, which exposes a method to manually exit the app (unmount).
 */


const useApp = () => react.useContext(AppContext_1$2.default);

var _default$C = useApp;
...
const StdoutContext_1$2 = __importDefault$m(StdoutContext_1);
/**
 * `useStdout` is a React hook, which exposes stdout stream.
 */


const useStdout = () => react.useContext(StdoutContext_1$2.default);

var _default$D = useStdout;
...
const StderrContext_1$2 = __importDefault$n(StderrContext_1);
/**
 * `useStderr` is a React hook, which exposes stderr stream.
 */


const useStderr = () => react.useContext(StderrContext_1$2.default);

var _default$E = useStderr;
...
const FocusContext_1$2 = __importDefault$o(FocusContext_1);

const use_stdin_1$1 = __importDefault$o(useStdin_1);
/**
...
const useFocus = ({
  ...
  const {
    ...
    activate,
    deactivate
  } = react.useContext(FocusContext_1$2.default);
...
const FocusContext_1$3 = __importDefault$p(FocusContext_1);
/**
...
const useFocusManager = () => {
  const focusContext = react.useContext(FocusContext_1$3.default);
  return {
...
var _default$G = useFocusManager;
...
var _default$I = spinners;
cliSpinners.default = _default$I;

const react_1$9 = react;
...
const Spinner = ({
  ...
  const [frame, setFrame] = react_1$9.useState(0);
  ...
  return react.createElement(build$1.Text, null, spinner.frames[frame]);
};

var _default$J = Spinner;
...
function Spinner$1({
  ...
  return /*#__PURE__*/react.createElement(build$1.Box, null, /*#__PURE__*/react.createElement(build$1.Text, null, /*#__PURE__*/react.createElement(_default$J, {
    type: "dots"
  }), " ", label));
}
...
function ProgressBar({
  ...
  return /*#__PURE__*/react.createElement(build$1.Box, {
    flexDirection: "row"
  }, /*#__PURE__*/react.createElement(build$1.Box, {
    marginRight: 3,
    width: progressBarWidth
  }, /*#__PURE__*/react.createElement(build$1.Text, null, "["), /*#__PURE__*/react.createElement(build$1.Box, {
    width: progressBarWidth - 2
  }, /*#__PURE__*/react.createElement(build$1.Text, null, `=`.repeat((progressBarWidth - 2) * percentage / 100))), /*#__PURE__*/react.createElement(build$1.Text, null, "]")), /*#__PURE__*/react.createElement(build$1.Box, {
    marginRight: 1
  }, /*#__PURE__*/react.createElement(build$1.Text, null, calcElapsedTime(startTime), " s")), /*#__PURE__*/react.createElement(build$1.Box, {
    marginRight: 1
  }, /*#__PURE__*/react.createElement(build$1.Text, null, current, "/", total)), /*#__PURE__*/react.createElement(build$1.Box, {
    marginRight: 1
  }, /*#__PURE__*/react.createElement(build$1.Text, null, `` + percentage, "%")), /*#__PURE__*/react.createElement(build$1.Box, null, /*#__PURE__*/react.createElement(build$1.Text, {
    wrap: "truncate"
  }, message)));
}

const createLabel = (text, color) => (...props) => /*#__PURE__*/react.createElement(build$1.Text, _extends({
  color: color
}, props), text);
...
const Message = /*#__PURE__*/react.memo(({
  ...
  if (!level || level === `LOG`) {
    return /*#__PURE__*/react.createElement(build$1.Text, null, message);
  }
...
const File = ({
  ...
  return /*#__PURE__*/react.createElement(build$1.Text, {
    color: "blue"
...
const DocsLink = ({
  ...
  return /*#__PURE__*/react.createElement(build$1.Box, {
    marginTop: 1
  }, /*#__PURE__*/react.createElement(build$1.Text, null, "See our docs page for more info on this error: ", docsUrl));
};
...
react.createElement(build$1.Box, {
  marginY: 1,
  flexDirection: "column"
}, /*#__PURE__*/react.createElement(build$1.Box, {
  flexDirection: "column"
  ...
  flexDirection: "column"
}, /*#__PURE__*/react.createElement(build$1.Box, null, /*#__PURE__*/react.createElement(build$1.Box, {
  marginRight: 1
}, /*#__PURE__*/react.createElement(build$1.Text, {
  color: "black",
  backgroundColor: "red"
}, ` ${details.level} `, details.code ? `#${details.code} ` : ``), /*#__PURE__*/react.createElement(build$1.Text, {
  color: "red"
}, details.type ? ` ` + details.type : ``))), /*#__PURE__*/react.createElement(build$1.Box, {
  marginTop: 1
}, /*#__PURE__*/react.createElement(build$1.Text, null, details.text)), details.filePath && /*#__PURE__*/react.createElement(build$1.Box, {
  marginTop: 1
}, /*#__PURE__*/react.createElement(build$1.Text, null, "File:", ` `), /*#__PURE__*/react.createElement(File, {
...
const useTerminalResize = () => {
  const {
    stdout
  } = build$1.useStdout(); // stdout type is nullable, so we need to handle case where it is undefined for type checking.
...
const Develop = ({
  ...
  return /*#__PURE__*/react.createElement(build$1.Box, {
    flexDirection: "column",
    marginTop: 2
  }, /*#__PURE__*/react.createElement(build$1.Box, null, /*#__PURE__*/react.createElement(build$1.Text, {
    wrap: "truncate"
  }, `—`.repeat(width))), /*#__PURE__*/react.createElement(build$1.Box, {
    height: 1,
    flexDirection: "row"
  }, /*#__PURE__*/react.createElement(StatusLabel, null), /*#__PURE__*/react.createElement(build$1.Box, {
    flexGrow: 1
  }), /*#__PURE__*/react.createElement(build$1.Text, null, appName), /*#__PURE__*/react.createElement(build$1.Box, {
    flexGrow: 1
  }), /*#__PURE__*/react.createElement(build$1.Text, null, pagesCount, " pages")));
};
...
class CLI extends react.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/react.createElement(build$1.Box, {
      ...
      flexDirection: "column"
    }, /*#__PURE__*/react.createElement(build$1.Static, {
      items: messages
      ...
      key: messages.indexOf(message)
    }, message))), spinners.map(activity => /*#__PURE__*/react.createElement(Spinner$1, _extends({
      key: activity.id
...
function initializeINKLogger() {
  build$1.render( /*#__PURE__*/react.createElement(StoreStateProvider, null, /*#__PURE__*/react.createElement(ConnectedCLI, null)));
}
