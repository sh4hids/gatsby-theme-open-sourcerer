...
var entry = require('./entry-0e98bb8d.js');
...
const react_1$1 = __importDefault$b(entry.react);

const chalk_1$1 = __importDefault$b(source);
...
const fs = __importStar$1(fs__default['default']);

const react_1$2 = __importDefault$c(entry.react);
...
const react_1$3 = __importStar$2(entry.react);
...
const react_1$4 = __importDefault$e(entry.react);
...
const signal_exit_1 = __importDefault$e(signalExit);
...
const react_1$5 = __importStar$4(entry.react);
/**
...
const react_1$6 = __importDefault$g(entry.react);
/**
...
const react_1$7 = __importDefault$h(entry.react);
/**
...
const react_1$8 = __importDefault$i(entry.react);
...
const useStdin = () => entry.react.useContext(StdinContext_1$2.default);
...
const useApp = () => entry.react.useContext(AppContext_1$2.default);
...
const useStdout = () => entry.react.useContext(StdoutContext_1$2.default);
...
const useStderr = () => entry.react.useContext(StderrContext_1$2.default);
...
const useFocus = ({
  ...
  const {
    ...
    activate,
    deactivate
  } = entry.react.useContext(FocusContext_1$2.default);
...
const useFocusManager = () => {
  const focusContext = entry.react.useContext(FocusContext_1$3.default);
  return {
...
function SelectInput({
  ...
  const [rotateIndex, setRotateIndex] = react_1$9.useState(0);
  const [selectedIndex, setSelectedIndex] = react_1$9.useState(initialIndex);
  const hasLimit = typeof customLimit === 'number' && items.length > customLimit;
  const limit = hasLimit ? Math.min(customLimit, items.length) : items.length;
  const previousItems = react_1$9.useRef(items);
  react_1$9.useEffect(() => {
  ...
  build$1.useInput(react_1$9.useCallback((input, key) => {
...
var SelectInput$1 = /*@__PURE__*/entry.getDefaultExportFromCjs(build$2);
...
var _default$L = spinners;
cliSpinners.default = _default$L;

const react_1$a = entry.react;
...
const Spinner = ({
  ...
  const [frame, setFrame] = react_1$a.useState(0);
...
function y(a) {
  if ("string" == typeof a) {
    var b = n(5381, v$1(a)) >>> 0;
    a = x$1.get(b) || parse(a, {
      noLocation: !0
    });
  } else {
    b = a.__key || n(5381, v$1(a)) >>> 0, a = x$1.get(b) || a;
  }
...
function z$1(a, b, c) {
  return {
    operation: a,
    data: b.data,
    error: Array.isArray(b.errors) ? new m$1({
...
function createRequest(a, b) {
  a = y(a);
  return {
    key: b ? n(a.__key, u$1(b)) >>> 0 : a.__key,
    query: a,
    variables: b || {}
  };
}
...
function n$1(a, b) {
  if (Array.isArray(a)) {
    ...
    for (c in a) {
      "__typename" === c && "string" == typeof a[c] ? b[a[c]] = 0 : n$1(a[c], b);
    }
  }
...
function r$2(a) {
  if (a.selectionSet && !a.selectionSet.selections.some(p$1)) {
    return B$1({}, a, {
...
function u$2(a) {
  a = y(a);
  var b = t$2.get(a.__key);
  b || ((b = entry.visit(a, {
    Field: r$2,
    InlineFragment: r$2
  })).__key = a.__key, t$2.set(a.__key, b));
  return b;
}
...
function v$2(a) {
  return a && "object" == typeof a ? Object.keys(a).reduce(function (b, c) {
    ...
    "__typename" === c ? Object.defineProperty(b, "__typename", {
      enumerable: !1,
      value: d
    }) : Array.isArray(d) ? b[c] = d.map(v$2) : b[c] = d && "object" == typeof d && "__typename" in d ? v$2(d) : d;
    return b;
  }, {}) : a;
}
...
function A$1(a, b) {
  return z$2(a.kind, a, B$1({}, a.context, {
...
function K$1(a) {
  ...
  function e(a) {
    ...
    if (d) {
      e = Object.keys(n$1(a.data, {})).concat(d.context.additionalTypenames || []);
  ...
  return function (a) {
    ...
    b = H(e)(g(filter$1(H$1)(map$1(I)(merge$1([map$1(G)(filter$1(f)(b)), filter$1(J$1)(b)])))));
    return merge$1([a, b]);
  };
}

function L(a, b) {
  return a.reexecuteOperation(z$2(b.kind, b, B$1({}, b.context, {
...
function X(a) {
  ...
  this.createRequestOperation = function (a, b, d) {
    return z$2(a, b, c.createOperationContext(d));
  };
  ...
  return function (a) {
    function d(a) {
      ...
      return make$1(function (c) {
        ...
        function f() {
          k || (k = !0, "subscription" === a.kind && m.reexecuteOperation(z$2("teardown", a, a.context)), g());
        }
...
X.prototype.onOperationEnd = function (a) {
  ...
  if (0 >= (this.activeOperations[b] = 0 >= c ? 0 : c - 1)) {
    ...
    this.dispatchOperation(z$2("teardown", a, a.context));
  }
};
...
X.prototype.executeRequestOperation = function (a) {
  ...
  return "query" === a.kind && a.context.pollInterval ? K(function c() {
    return g;
...
X.prototype.query = function (a, b, c) {
  ...
  return w$1(this.executeQuery(createRequest(a, b), c));
};
...
X.prototype.mutation = function (a, b, c) {
  return w$1(this.executeMutation(createRequest(a, b), c));
};
...
function useSubscription(args, handler) {
  ...
  state = (ref = useSource(subscription$ = entry.react.useMemo(function () {
    ...
    return scan$1(_ref, prevState || initialState)(K(_ref3$2)(subscription$$));
  }, [])))[0];
...
const RecipesList = ({
  ...
  return /*#__PURE__*/entry.react.createElement(SelectInput$1, {
    items: items,
    onSelect: setRecipe,
...
var cli = (async ({
  ...
  try {
    ...
    }, /*#__PURE__*/entry.react.createElement(build$1.Text, null, p.isDone ? `✔ ` : /*#__PURE__*/entry.react.createElement(_default$M, null), ` `, /*#__PURE__*/entry.react.createElement(build$1.Text, {
      italic: true
    ...
    const RecipeInterpreter = () => {
      ...
      if (!isReady) {
        return /*#__PURE__*/entry.react.createElement(build$1.Text, null, /*#__PURE__*/entry.react.createElement(_default$M, null), " Loading recipe");
      }
